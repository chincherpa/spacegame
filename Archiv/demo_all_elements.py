...
def make_window(theme):
    ...
    asthetic_layout = [[sg.T('Anything that you would use for asthetics is in this tab!')],
               ...
               [sg.ProgressBar(100, orientation='h', size=(20, 20), key='-PROGRESS BAR-', visible=False), sg.Button('Test Progress bar')],
              #  [sg.ProgressBar(999, orientation='h', size=(20, 20))]
               ]
    ...
    window = sg.Window('All Elements Demo',
    layout,

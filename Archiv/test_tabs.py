...
layout = [[
    sg.TabGroup([[sg.Tab('Tab 1', tab1_layout, background_color='darkslateblue', key='-mykey1-'),
           ...
           sg.TabGroup([[sg.Tab('Tab 4', tab4_layout, background_color='darkseagreen', key='-mykey2-'),
                         sg.Tab('Tab 5', tab5_layout)]], key='-group1-', tab_location='bottom', selected_title_color='purple')],
          # [sg.TabGroup([[sg.Tab('Tab 1', tab1_layout, background_color='darkslateblue', key='-mykey3-'),
          #                sg.Tab('Tab 2', tab2_layout, background_color='tan1'),
          #                sg.Tab('Tab 3', tab3_layout)]],
          #              key='-group3-', title_color='red',
          #              selected_title_color='green', tab_location='left'),
          # [
          #      sg.TabGroup([[sg.Tab('Tab 4', tab4_layout, background_color='darkseagreen', key='-mykey4-'),
